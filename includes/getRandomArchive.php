...
// Fetch random audio entries from the database
$sql = "SELECT id, audio_title_user_uploaded, audio_description, audio_logo_url, audio_url, audio_scheduled_time_to_play, audio_time_actually_played, audio_time_actually_ended FROM audios ORDER BY RAND() LIMIT 100";
